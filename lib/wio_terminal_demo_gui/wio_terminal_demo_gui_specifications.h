...
#ifndef _WIO_TERMINAL_DEMO_GUI_SPECIFICATIONS_H_
#define _WIO_TERMINAL_DEMO_GUI_SPECIFICATIONS_H_
...
enum user_defined_events{
    LOADING_COMPLETE = GX_FIRST_USER_EVENT,
...
typedef struct SECOND_WINDOW_CONTROL_BLOCK_STRUCT
{
    GX_WINDOW_MEMBERS_DECLARE
    GX_ICON SECOND_WINDOW_icon;
} SECOND_WINDOW_CONTROL_BLOCK;
...
extern SECOND_WINDOW_CONTROL_BLOCK SECOND_WINDOW;
